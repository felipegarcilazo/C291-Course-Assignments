...
int main(){
  ...
  while (1){
    ...
    //Using if else if and else to calculate the paycodes
   
    if(pay_code == 'W' || pay_code == 'w'){
      ...
      printf("%c is an invalid paycode.\n", pay_code);
    }
